...
const Footer = () => {
  ...
  return (
    <footer id="login" className="bg-navy-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Start getting voice feedback that actually helps your business grow.
          </p>
          <Button 
            size="lg"
        ...
        <div className="border-t border-gray-700 pt-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              <h3 className="text-2xl font-bold mb-4">Telora</h3>
              <p className="text-gray-300 mb-6 max-w-md">
                AI voice feedback platform that helps e-commerce businesses get real customer insights through automated phone calls.
              </p>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Telora. All rights reserved.
            </p>
